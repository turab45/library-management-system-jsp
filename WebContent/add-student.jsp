...
<body style="font-family: Lora, serif;background-color: #fff;">
    <ul class="nav flex-column d-flex sidebar mobile-hid" style="background-color: rgb(31,40,81);">
        ...
        <li class="nav-item dropdown"><a class="dropdown-toggle nav-link text-left text-white py-1 px-0 position-relative" data-toggle="dropdown" aria-expanded="false" href="#"><i class="fas fa-users mx-3"></i><span class="text-nowrap mx-2">Students</span><i class="fas fa-caret-down float-none float-lg-right fa-sm"></i></a>
            <div
                class="dropdown-menu border-0 animated fadeIn" role="menu"><a class="dropdown-item text-white" role="presentation" href="#">Add Student</a><a class="dropdown-item text-white" role="presentation" href="view-students.html">View Students</a></div>
        </li>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group"><label style="color: rgb(31,40,81);font-weight: bold;font-size: 16px;">Firstname </label><input class="form-control" type="text" name="firstname" style="border-color: rgb(31,40,81);color: rgb(31,40,81);font-size: 14px;"></div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group"><label style="color: rgb(31,40,81);font-weight: bold;font-size: 16px;">Lastname </label><input class="form-control" type="text" name="lastname" style="border-color: rgb(31,40,81);color: rgb(31,40,81);font-size: 14px;"></div>
                                    </div>
                                </div>
                                ...
                                <div
                                    class="form-row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group"><label style="color: rgb(31,40,81);font-size: 16px;font-weight: bold;">Contact</label><input class="form-control" type="tel" style="border-color: rgb(31,40,81);color: rgb(31,40,81);font-size: 14px;"></div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group"><label style="color: rgb(31,40,81);font-size: 16px;font-weight: bold;">Date of Birth</label><input class="form-control" type="date" style="border-color: rgb(31,40,81);font-size: 14px;color: rgb(31,40,81);"></div>
                                    </div>
                            </div>
